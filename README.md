...
A collection of CLI tools which make it easy to write pipelines processing various data files. Using these tools in conjunction with [jq](https://stedolan.github.io/jq/), you can write data processing prototypes in seconds!
